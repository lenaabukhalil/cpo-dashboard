        ...
        <CardContent className="space-y-5 px-6 pb-6 pt-2">
          <div className="flex flex-wrap items-end gap-4 md:gap-6">
            ...
            <div className="flex flex-wrap items-center gap-4 rtl:gap-4">
              ...
              {rangeMode === 'dates' && (
                <>
                  <Input type="date" value={dateFrom} onChange={(e) => setDateFrom(e.target.value)} placeholder={t('common.datePlaceholder')} className="min-h-[44px] w-full sm:w-36" />
                  <span className="text-muted-foreground">–</span>
                  <Input type="date" value={dateTo} onChange={(e) => setDateTo(e.target.value)} placeholder={t('common.datePlaceholder')} className="min-h-[44px] w-full sm:w-36" />
                </>
              )}
            </div>
            <Button
